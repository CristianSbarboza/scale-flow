...
> **Para agentes:** SUB-SKILL OBRIGATÓRIA: use `superpowers:subagent-driven-development` (recomendado) ou `superpowers:executing-plans` para executar tarefa por tarefa. Os passos usam checkbox (`- [x]`) para rastreio.
...
- [x] **Step 1: Capturar a superfície atual**
...
- [x] **Step 2: Escrever o script de verificação**
...
- [x] **Step 3: Rodar o script contra o código intacto para provar que ele passa**
...
- [x] **Step 4: Registrar o baseline de build**
...
- [x] **Step 1: Criar `src/types/domain.ts`**
...
- [x] **Step 2: Remover as interfaces de `actions.ts` e importar do novo módulo**
...
- [x] **Step 3: Atualizar os 10 consumidores de tipo**
...
- [x] **Step 1: Criar `src/lib/scope.ts`**
...
- [x] **Step 2: Remover os helpers de `actions.ts` e importar de `scope.ts`**
...
- [x] **Step 4: Confirmar que `server-only` protege de verdade**
...
- [x] **Step 1: Criar `src/lib/actions/ministries.ts`**
...
- [x] **Step 2: Criar `src/lib/actions/sectors.ts`**
...
- [x] **Step 3: Remover as 7 de `actions.ts`**
...
- [x] **Step 4: Atualizar os 8 consumidores**
...
- [x] **Step 1: Criar `src/lib/actions/servants.ts`**
...
- [x] **Step 2: Remover as 8 de `actions.ts`**

Apague os blocos listados no Step 1 e limpe imports órfãos.

- [x] **Step 3: Atualizar os 2 consumidores**
...
- [x] **Step 1: Criar `src/lib/actions/schedules.ts`**
...
- [x] **Step 2: Remover as 6 de `actions.ts`** e limpar imports órfãos (`nanoid` sai de `actions.ts`).

- [x] **Step 3: Atualizar os 5 consumidores**
...
- [x] **Step 1: Criar `src/lib/actions/availability.ts`**
...
- [x] **Step 2: Criar `src/lib/actions/swaps.ts`**
...
- [x] **Step 3: Remover as 7 de `actions.ts`** e limpar imports órfãos.

- [x] **Step 4: Atualizar os 5 consumidores**
...
- [x] **Step 1: Criar `src/lib/actions/account.ts`**
...
- [x] **Step 2: Criar `src/lib/actions/coordinator.ts`**
...
- [x] **Step 3: Confirmar que `actions.ts` está vazio e deletar**
...
- [x] **Step 4: Atualizar os 4 consumidores**
...
- [x] **Step 5: Verificar que nada mais aponta para o módulo velho**
...
- [x] **Step 6: Conferir o tamanho dos módulos**
...
- [x] **Step 6: Link público de escala nos dois modos**
...
- [x] **Step 7: Registrar em `validation.md`**
...
- [x] **Step 2: Implementar `getScope()` em `src/lib/scope.ts`**
...
- [x] **Step 3: Migrar os 7 consumidores de `getAuthFilter`**
...
- [x] **Step 4: Remover `getAuthFilter`**
...
- [x] **Step 6: Repetir a verificação de líder e de admin**
...
- [x] **Step 1: Adicionar o mapeamento compartilhado a `src/lib/scope.ts`**
...
- [x] **Step 2: Reescrever `coordinator.ts` para não chamar action de action**
...
- [x] **Step 3: Remover a duplicação em `src/app/servant/page.tsx`**
...
- [x] **Step 5: Confirmar que nenhum módulo de action importa outro (RNF06)**
...
- [x] **Step 6: Repetir a verificação de coordenador e de servo**

Refaça os Steps 4 e 5 da Tarefa 9 — é o que esta tarefa afeta.

- [x] **Step 7: Rodar o checklist completo dos critérios de aceitação**
...
- [x] **Step 8: Atualizar `validation.md` e commitar**
